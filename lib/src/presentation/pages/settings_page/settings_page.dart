...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(S.of(context).settings, style: Theme.of(context).textTheme.headline6),
        ),
            ...
            children: [
              ...
              RadioListTile<Language>(
                ...
                onChanged: (changeValue) {
                  setState(() {
                    context.read<AppCubit>().changeLanguage(changeValue ?? Language.es);
                  });
                },
                title: Text(
              ...
              RadioListTile<Language>(
                ...
                onChanged: (changeValue) {
                  setState(() {
                    context.read<AppCubit>().changeLanguage(changeValue ?? Language.en);
                  });
                },
                title: Text(
