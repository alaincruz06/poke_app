...
import 'package:poke_app/src/presentation/pages/basic_pages/items_page/widgets/item_container_widget.dart';
...
class ItemsPage extends StatelessWidget {
  ...
  final itemsProvider = ItemProvider();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(alignment: AlignmentDirectional.topCenter, children: [
        ...
        SearchWidget(context: context, type: 'items'),
