      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ListTile(
              title: Row(
                ...
                children: const [
                  CircleAvatar(
                    foregroundImage:
                        AssetImage(Assets.assetsImagesPokedexAppLogo),
                  )
                ],
              ),
            ),
            ...
            ListTile(
              leading: Image.asset(Assets.assetsIconsIWillGo100px,
                  height: navigationDrawerIconsHeight,
                  width: navigationDrawerIconsWidth,
                  color: Theme.of(context).iconTheme.color),
            ...
            ListTile(
              leading: Image.asset(Assets.assetsIconsMarker100px,
                  height: navigationDrawerIconsHeight,
                  width: navigationDrawerIconsWidth,
                  color: Theme.of(context).iconTheme.color),
            ...
            ListTile(
              leading: Image.asset(Assets.assetsIconsHairBrush100px,
                  height: navigationDrawerIconsHeight,
                  width: navigationDrawerIconsWidth,
                  color: Theme.of(context).iconTheme.color),
